...
async def page_snap(page: Page) -> str:
    ...
    for link in soup.find_all(link_as_style_filter):
        print('Hit tags with inline styles using resources')
